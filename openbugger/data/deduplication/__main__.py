...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="A server process for keeping track of duplicates."
    )
    parser.add_argument(
        "save_path", type=str, help="a location to the state of the server."
    )
    parser.add_argument(
        "--address",
        default="tcp://*:5555",
        help="Address where the server will be listening at.",
    )
