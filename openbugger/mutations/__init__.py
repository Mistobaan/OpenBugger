...
from openbugger.mutations.rewrite_ops import AbstractRewriteOp
from openbugger.mutations.rewrite_scouts import (
    ArgSwapRewriteScout,
    AssignRewriteScout,
...
from openbugger.mutations.semantics_preserving import (
    CommentDelete,
    IfElseSwap,
    MirrorComparisons,
    RenameVariableInLocalScope,
)
from openbugger.utils.cstutils import subsumes_code_range
...
def filter_ops_in_range(
    ...
    List[AbstractRewriteOp], List[Tuple[Type[ICodeRewriteScout], cst.CSTNode, Any]]
]:
